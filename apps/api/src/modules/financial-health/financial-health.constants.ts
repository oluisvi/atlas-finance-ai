...
export function budgetControlScore(exceeded: number, alerts: number, usage: number): number { if (usage >= 150) return 0; if (exceeded > 1) return 25; if (exceeded === 1) return 50; return alerts > 0 ? 75 : 100; }
